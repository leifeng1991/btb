...
public class WalletActivity_ViewBinding implements Unbinder {
  ...
  public WalletActivity_ViewBinding(WalletActivity target, View source) {
    ...
    target.rvWalletOption = Utils.findRequiredViewAsType(source, R.id.rvWallet_option, "field 'rvWalletOption'", RecyclerView.class);
    target.llOption = Utils.findRequiredViewAsType(source, R.id.ll_option, "field 'llOption'", LinearLayout.class);
    target.llOptionTab = Utils.findRequiredViewAsType(source, R.id.ll_option_tab, "field 'llOptionTab'", LinearLayout.class);
    target.tvOption = Utils.findRequiredViewAsType(source, R.id.tv_option, "field 'tvOption'", TextView.class);
    target.optionUnderline = Utils.findRequiredView(source, R.id.option_underline, "field 'optionUnderline'");
  ...
  public void unbind() {
    ...
    target.rvWalletOption = null;
    target.llOption = null;
    target.llOptionTab = null;
    target.tvOption = null;
    target.optionUnderline = null;
