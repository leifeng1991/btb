...
public final class ActivityAboutUsBinding implements ViewBinding {
  ...
  private ActivityAboutUsBinding(@NonNull LinearLayout rootView, @NonNull ImageButton ibBack,
      @NonNull TextView ibRegist, @NonNull LinearLayout llTitle, @NonNull View viewBack) {
  ...
  public static ActivityAboutUsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutUsBinding((LinearLayout) rootView, ibBack, ibRegist, llTitle,
          viewBack);
    }
