...
public final class ActivityAddressBinding implements ViewBinding {
  ...
  private ActivityAddressBinding(@NonNull LinearLayout rootView, @NonNull ImageButton ibBack,
      @NonNull TextView ibRegist, @NonNull LinearLayout llTitle, @NonNull RecyclerView rvAddress,
  ...
  public static ActivityAddressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView rvAddress = rootView.findViewById(R.id.rvAddress);
      if (rvAddress == null) {
        missingId = "rvAddress";
        break missingId;
      }
      ...
      return new ActivityAddressBinding((LinearLayout) rootView, ibBack, ibRegist, llTitle,
          rvAddress, tvTitle, viewBack);
    }
