...
public final class FragmentSevenBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentSevenBinding(@NonNull LinearLayout rootView, @NonNull TextView btnToLogin,
      @NonNull Button buFall, @NonNull Button buRise, @NonNull View currentTrustUnderline,
      @NonNull View dealTrustUnderline, @NonNull View historyTrustUnderline,
      @NonNull ImageView ibMessage, @NonNull ImageButton ibOpen, @NonNull TextView installments,
      @NonNull KLineView klineView, @NonNull LinearLayout llCurrent,
      ...
      @NonNull LinearLayout llOneCurrent, @NonNull LinearLayout llRoot,
      ...
      @NonNull TextView nowThree, @NonNull TextView nowTwo, @NonNull RecyclerView rvAmount,
      @NonNull RecyclerView rvHistory, @NonNull RecyclerView rvOption, @NonNull SeekBar seekbar,
      @NonNull SmartRefreshLayout smartrefreshLayout, @NonNull TabLayout tab,
      @NonNull LinearLayout tabTime, @NonNull RelativeLayout textToAll, @NonNull TextView tvAmount,
      @NonNull TextView tvAmount2, @NonNull TextView tvBuy, @NonNull TextView tvBuy2,
  ...
  @NonNull
  public static FragmentSevenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSevenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_seven, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSevenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView rvOption = rootView.findViewById(R.id.rv_option);
      if (rvOption == null) {
        missingId = "rvOption";
        break missingId;
      }
      ...
      return new FragmentSevenBinding((LinearLayout) rootView, btnToLogin, buFall, buRise,
          currentTrustUnderline, dealTrustUnderline, historyTrustUnderline, ibMessage, ibOpen,
          installments, klineView, llCurrent, llCurrentTrust, llDeal, llDealTrust, llHistory,
          llHistoryTrust, llK, llOneCurrent, llRoot, llTitle, mTvseven, nowFive, nowFour, nowOne,
          nowSix, nowThree, nowTwo, rvAmount, rvHistory, rvOption, seekbar, smartrefreshLayout, tab,
          tabTime, textToAll, tvAmount, tvAmount2, tvBuy, tvBuy2, tvCurrentTrust, tvDealTrust,
          tvExpect, tvExpect2, tvHistoryTrust, tvNowPrice, tvOpenPrice, tvPercent, tvSell, tvSell2,
          tvTime, tvTime2, tvTimeCurrent, tvTitle, tvUseMoney, viewLine);
    }
