...
public final class ActivityChatListBinding implements ViewBinding {
  ...
  @NonNull
  public final SwipeMenuRecyclerView rvChat;
  ...
  private ActivityChatListBinding(@NonNull LinearLayout rootView, @NonNull ImageButton ibBack,
      @NonNull TextView ibRegist, @NonNull LinearLayout llTitle, @NonNull RelativeLayout rlEmpty,
      @NonNull SwipeMenuRecyclerView rvChat, @NonNull TextView tvMessage, @NonNull View viewBack) {
  ...
  public static ActivityChatListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      SwipeMenuRecyclerView rvChat = rootView.findViewById(R.id.rvChat);
      if (rvChat == null) {
        missingId = "rvChat";
        break missingId;
      }
      ...
      return new ActivityChatListBinding((LinearLayout) rootView, ibBack, ibRegist, llTitle,
          rlEmpty, rvChat, tvMessage, viewBack);
    }
