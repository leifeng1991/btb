...
public final class ActivityFeedbackBinding implements ViewBinding {
  ...
  private ActivityFeedbackBinding(@NonNull RelativeLayout rootView, @NonNull EditText etRemark,
      @NonNull ImageButton ibBack, @NonNull TextView ibRegist, @NonNull LinearLayout llContainer,
      @NonNull LinearLayout llTitle, @NonNull TextView tvSubmit, @NonNull View viewBack) {
  ...
  public static ActivityFeedbackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFeedbackBinding((RelativeLayout) rootView, etRemark, ibBack, ibRegist,
          llContainer, llTitle, tvSubmit, viewBack);
    }
