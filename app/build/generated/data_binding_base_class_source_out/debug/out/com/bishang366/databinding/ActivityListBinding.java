...
public final class ActivityListBinding implements ViewBinding {
  ...
  private ActivityListBinding(@NonNull LinearLayout rootView, @NonNull ImageButton ibBack,
  ...
  public static ActivityListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityListBinding((LinearLayout) rootView, ibBack, ibMessage, llTitle, tab,
          vpPager);
    }
