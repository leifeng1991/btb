...
import com.bishang366.config.UrlConfig;
...
public class UrlFactory {
    ...
    //----------创新实验室--------------
    public static String getALab() {
        return host + "/uc/activity/page-query";
    }

    //活动详情
    public static String getALabDetail() {
        return host + "/uc/activity/detail";
    }

    //用户参与活动列表
    public static String getMemberRecords() {
        return host + "/uc/activity/getmemberrecords";
    }

    //活动邮箱验证码
    public static String getALbEmailCode() {
        return host + "/uc/activity/code";
    }

    //活动手机验证码
    public static String getALbMobileCode() {
        return host + "/uc/mobile/activity/code";
    }
    //参加活动
    public static String getALbAttend() {
        return host + "/uc/activity/attend";
    }
    //我参与的活动
    public static String getMyAttendRecords()
    {
        return host +"/uc/activity/getmyorders";
    }
    //我的矿机
    public static String getMyMinings()
    {
        return host +"/uc/miningorder/my-minings";
    }
    //我的锁仓
    public static String getMylocked()
    {
        return host +"/uc/lockedorder/my-locked";
    }


    //获取当前交易对持仓记录
    public static String getSecondOptionCurrent() {
        return host + "/second/order/current";
    }

    //获取可交易币种
    public static String getSecondOptionCoins() {
        return host + "/second/order/coins";
    }

    //获取周期
    public static String getSecondOptionCycles() {
        return host + "/second/order/cycles";
    }

    //获取包赔设置
    public static String getSecondOptionAllSets() {
        return host + "/second/order/getAllSets";
    }

    //获取当前交易对历史记录
    public static String getSecondOptionHistory() {
        return host + "/second/order/history";
    }

    //下单接口
    public static String getSecondOptionAdd() {
        return host + "/second/order/add";
    }

    public static String getAllCurrencySecond() {
        return host + "/second/symbol-thumb";
    }

    //查询账号
    public static String getSecondWalletList() {
        return host + "/second/wallet/list";
    }

    //查询期权账户可用余额 url拼接参数  USDT 、BTC
    public static String getSecondWalletBalance(String coinSymbol) {
        return host + "/second/wallet/balance/"+coinSymbol;
    }

    //资金划转
    public static String getSecondWalletTrans() {
        return host + "/second/wallet/trans";
    }
}
